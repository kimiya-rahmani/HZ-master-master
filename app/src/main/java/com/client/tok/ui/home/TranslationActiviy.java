...
import com.client.tok.utils.QueryUtils;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Locale;

import static com.client.tok.utils.GlobalVars.BASE_REQ_URL;
import static com.client.tok.utils.GlobalVars.DEFAULT_LANG_POS;
import static com.client.tok.utils.GlobalVars.LANGUAGE_CODES;

public class TranslationActiviy extends AppCompatActivity implements TextToSpeech.OnInitListener{
    public static final String LOG_TAG = TranslationActiviy.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_translation_activiy);
        ...
        process_tts = new Dialog(TranslationActiviy.this);
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                     ...
                     */
                    final Dialog match_text_dialog = new Dialog(TranslationActiviy.this);
    ...
    private class GetLanguages extends AsyncTask<Void,Void,ArrayList<String>>{
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (activityRunning) {
                ArrayAdapter<String> adapter = new ArrayAdapter<>(TranslationActiviy.this, android.R.layout.simple_spinner_item, result);
